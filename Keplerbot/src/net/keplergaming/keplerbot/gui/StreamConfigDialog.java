...
public class StreamConfigDialog extends JDialog {
	...
	public StreamConfigDialog(JFrame parent, final KeplerBotWrapper wrapper) {
		...
		panelNews.setBorder(new BevelBorder(BevelBorder.LOWERED, null, null, null, null));

		GroupLayout gl_contentPanel = new GroupLayout(contentPanel);
		gl_contentPanel.setHorizontalGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPanel.createSequentialGroup().addContainerGap().addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING, false).addGroup(gl_contentPanel.createSequentialGroup().addComponent(panelColor, GroupLayout.PREFERRED_SIZE, 376, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED).addComponent(panelFilter, GroupLayout.PREFERRED_SIZE, 131, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED).addComponent(panelMute, GroupLayout.PREFERRED_SIZE, 122, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED).addComponent(panelNews, 0, 0, Short.MAX_VALUE)).addComponent(panelActions, GroupLayout.PREFERRED_SIZE, 757, GroupLayout.PREFERRED_SIZE)).addContainerGap(15, Short.MAX_VALUE)));
		gl_contentPanel.setVerticalGroup(gl_contentPanel.createParallelGroup(Alignment.TRAILING).addGroup(gl_contentPanel.createSequentialGroup().addContainerGap().addGroup(gl_contentPanel.createParallelGroup(Alignment.TRAILING).addComponent(panelNews, GroupLayout.DEFAULT_SIZE, 168, Short.MAX_VALUE).addComponent(panelColor, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 168, GroupLayout.PREFERRED_SIZE).addComponent(panelFilter, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 168, Short.MAX_VALUE).addComponent(panelMute, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addPreferredGap(ComponentPlacement.RELATED).addComponent(panelActions, GroupLayout.PREFERRED_SIZE, 167, GroupLayout.PREFERRED_SIZE).addGap(74)));
		
		JLabel lblNews = new JLabel("News");
		lblNews.setHorizontalAlignment(SwingConstants.CENTER);
		lblNews.setFont(new Font("Dialog", Font.BOLD, 13));
		
		JCheckBox chckbxNewsOn = new JCheckBox("On");
		chckbxNewsOn.setSelected(wrapper.getConfig().getBoolean(ConfigConstants.NEWS_ON.getKey(), (boolean) ConfigConstants.NEWS_ON.getDefaultValue()));
		chckbxNewsOn.setFont(new Font("Dialog", Font.PLAIN, 13));
		
		JLabel lblDelay = new JLabel("Delay");
		lblDelay.setFont(new Font("Dialog", Font.PLAIN, 13));
		
		JNumberTextField txtDelay = new JNumberTextField();
		txtDelay.setInt(wrapper.getConfig().getInteger(ConfigConstants.NEWS_DELAY.getKey(), (int) ConfigConstants.NEWS_DELAY.getDefaultValue()));
		txtDelay.setFont(new Font("Dialog", Font.PLAIN, 13));
		
		JLabel lblS = new JLabel("s");
		GroupLayout gl_panelNews = new GroupLayout(panelNews);
		gl_panelNews.setHorizontalGroup(gl_panelNews.createParallelGroup(Alignment.LEADING).addGroup(gl_panelNews.createSequentialGroup().addContainerGap().addGroup(gl_panelNews.createParallelGroup(Alignment.LEADING).addGroup(gl_panelNews.createParallelGroup(Alignment.TRAILING, false).addComponent(chckbxNewsOn, Alignment.LEADING).addComponent(lblNews, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 84, Short.MAX_VALUE)).addGroup(gl_panelNews.createSequentialGroup().addComponent(lblDelay).addPreferredGap(ComponentPlacement.RELATED).addComponent(txtDelay, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED).addComponent(lblS, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE))).addGap(30)));
		gl_panelNews.setVerticalGroup(gl_panelNews.createParallelGroup(Alignment.LEADING).addGroup(gl_panelNews.createSequentialGroup().addContainerGap().addComponent(lblNews, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE).addGap(18).addComponent(chckbxNewsOn).addPreferredGap(ComponentPlacement.UNRELATED).addGroup(gl_panelNews.createParallelGroup(Alignment.LEADING).addComponent(lblDelay).addGroup(gl_panelNews.createParallelGroup(Alignment.BASELINE).addComponent(txtDelay, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addComponent(lblS))).addContainerGap(59, Short.MAX_VALUE)));
		panelNews.setLayout(gl_panelNews);
		...
		gl_panelMute.setHorizontalGroup(gl_panelMute.createParallelGroup(Alignment.LEADING).addGroup(gl_panelMute.createSequentialGroup().addContainerGap().addGroup(gl_panelMute.createParallelGroup(Alignment.LEADING).addComponent(chckbxWarnings, GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE).addComponent(chckbxErrors, GroupLayout.PREFERRED_SIZE, 75, GroupLayout.PREFERRED_SIZE).addComponent(chckbxAll, GroupLayout.PREFERRED_SIZE, 74, GroupLayout.PREFERRED_SIZE).addComponent(lblMute)).addContainerGap()));
		...
		gl_panelFilter.setHorizontalGroup(gl_panelFilter.createParallelGroup(Alignment.LEADING).addGroup(gl_panelFilter.createSequentialGroup().addContainerGap().addGroup(gl_panelFilter.createParallelGroup(Alignment.TRAILING, false).addComponent(lblFilter, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(chckbxLinkFilter, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 97, GroupLayout.PREFERRED_SIZE).addGroup(Alignment.LEADING, gl_panelFilter.createSequentialGroup().addComponent(chckbxCapsFilter).addPreferredGap(ComponentPlacement.RELATED, 10, Short.MAX_VALUE)).addComponent(chckbxCensorFilter, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(chckbxColorFilter, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE)).addContainerGap()));
		...
		gl_panelColor.setHorizontalGroup(gl_panelColor.createParallelGroup(Alignment.LEADING).addGroup(gl_panelColor.createSequentialGroup().addGroup(gl_panelColor.createParallelGroup(Alignment.TRAILING, false).addGroup(Alignment.LEADING, gl_panelColor.createSequentialGroup().addContainerGap().addComponent(lblColor, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addGroup(Alignment.LEADING, gl_panelColor.createSequentialGroup().addGap(22).addGroup(gl_panelColor.createParallelGroup(Alignment.LEADING).addComponent(colorSpringGreen, GroupLayout.PREFERRED_SIZE, 104, GroupLayout.PREFERRED_SIZE).addComponent(colorRed, GroupLayout.PREFERRED_SIZE, 104, GroupLayout.PREFERRED_SIZE).addComponent(colorDodgerBlue, GroupLayout.PREFERRED_SIZE, 104, GroupLayout.PREFERRED_SIZE).addComponent(colorGoldenRod, GroupLayout.PREFERRED_SIZE, 104, GroupLayout.PREFERRED_SIZE).addComponent(colorGreen, GroupLayout.PREFERRED_SIZE, 104, GroupLayout.PREFERRED_SIZE)).addPreferredGap(ComponentPlacement.UNRELATED).addGroup(gl_panelColor.createParallelGroup(Alignment.LEADING).addComponent(colorBlue, GroupLayout.PREFERRED_SIZE, 104, GroupLayout.PREFERRED_SIZE).addComponent(colorChocolate, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addComponent(colorBlueViolet, GroupLayout.PREFERRED_SIZE, 104, GroupLayout.PREFERRED_SIZE).addComponent(colorHotPink, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addComponent(colorFireBrick, GroupLayout.PREFERRED_SIZE, 104, GroupLayout.PREFERRED_SIZE)).addPreferredGap(ComponentPlacement.RELATED).addGroup(gl_panelColor.createParallelGroup(Alignment.LEADING).addComponent(colorYellowGreen, GroupLayout.PREFERRED_SIZE, 104, GroupLayout.PREFERRED_SIZE).addComponent(colorOrangeRed, GroupLayout.PREFERRED_SIZE, 104, GroupLayout.PREFERRED_SIZE).addGroup(gl_panelColor.createParallelGroup(Alignment.LEADING).addComponent(colorCadetBlue, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 104, GroupLayout.PREFERRED_SIZE).addComponent(colorCoral, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 104, GroupLayout.PREFERRED_SIZE)).addComponent(colorSeaGreen, GroupLayout.PREFERRED_SIZE, 104, GroupLayout.PREFERRED_SIZE)))).addContainerGap(30, Short.MAX_VALUE)));
		gl_panelColor.setVerticalGroup(gl_panelColor.createParallelGroup(Alignment.LEADING).addGroup(gl_panelColor.createSequentialGroup().addContainerGap().addComponent(lblColor).addPreferredGap(ComponentPlacement.RELATED).addGroup(gl_panelColor.createParallelGroup(Alignment.LEADING).addComponent(colorCadetBlue, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE).addComponent(colorSpringGreen, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE).addComponent(colorBlue, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE)).addPreferredGap(ComponentPlacement.RELATED).addGroup(gl_panelColor.createParallelGroup(Alignment.LEADING, false).addGroup(gl_panelColor.createSequentialGroup().addComponent(colorCoral, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(colorYellowGreen, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE)).addGroup(gl_panelColor.createSequentialGroup().addComponent(colorChocolate, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(colorBlueViolet, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE)).addGroup(gl_panelColor.createSequentialGroup().addComponent(colorRed, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED).addComponent(colorDodgerBlue, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE))).addGroup(gl_panelColor.createParallelGroup(Alignment.LEADING).addGroup(gl_panelColor.createSequentialGroup().addPreferredGap(ComponentPlacement.RELATED).addGroup(gl_panelColor.createParallelGroup(Alignment.TRAILING).addComponent(colorGoldenRod, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE).addComponent(colorHotPink, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE))).addGroup(Alignment.TRAILING, gl_panelColor.createSequentialGroup().addPreferredGap(ComponentPlacement.RELATED).addComponent(colorOrangeRed, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE))).addGroup(gl_panelColor.createParallelGroup(Alignment.LEADING).addGroup(gl_panelColor.createSequentialGroup().addPreferredGap(ComponentPlacement.RELATED).addGroup(gl_panelColor.createParallelGroup(Alignment.TRAILING).addComponent(colorGreen, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE).addComponent(colorFireBrick, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE))).addGroup(Alignment.TRAILING, gl_panelColor.createSequentialGroup().addPreferredGap(ComponentPlacement.RELATED).addComponent(colorSeaGreen, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE))).addContainerGap(15, Short.MAX_VALUE)));
